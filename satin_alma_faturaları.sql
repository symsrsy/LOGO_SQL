...
FROM LG_004_01_INVOICE AS INVOICE WITH (NOLOCK)
RIGHT OUTER JOIN LG_004_01_STLINE AS STLINE ON INVOICE.LOGICALREF = STLINE.INVOICEREF
RIGHT OUTER JOIN LG_004_ITEMS INV ON INV.LOGICALREF=STLINE.STOCKREF
LEFT JOIN LG_004_SRVCARD SRV ON SRV.LOGICALREF=STLINE.STOCKREF
RIGHT OUTER JOIN LG_004_CLCARD CLCARD ON CLCARD.LOGICALREF=INVOICE.CLIENTREF
LEFT JOIN LG_004_EMUHACC EMUH ON EMUH.LOGICALREF=STLINE.ACCOUNTREF
RIGHT OUTER JOIN LG_004_UNITSETL UNT ON UNT.UNITSETREF=INV.UNITSETREF AND LINENR=1
