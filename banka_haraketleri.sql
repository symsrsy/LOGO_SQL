...
FROM
LG_004_01_BNFLINE AS BNL
LEFT JOIN LG_004_01_BNFICHE BNF ON BNF.LOGICALREF = BNL.SOURCEFREF
LEFT JOIN LG_004_BNCARD BNC ON BNC.LOGICALREF=BNL.BANKREF
LEFT JOIN LG_004_CLCARD CA ON CA.LOGICALREF = BNL.CLIENTREF
LEFT JOIN LG_004_BANKACC BACC ON BACC.LOGICALREF = BNL.BNACCREF
